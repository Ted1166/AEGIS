...
export function Dashboard({ address, signer, onNavigate }: DashboardProps) {
  ...
  return (
    <PageContent>
      <PageHeader
        title="Dashboard"
        subtitle={`Paseo Hub · Block #${guard.lastBlock?.toLocaleString() ?? '—'}`}
        right={
          guard.anyEmergency
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <Card>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              {[
                { label: 'Vault',    addr: '0x5ef526DFe9474E66c439Ca8FF31526f755F7aaBd' },
                { label: 'Guard',    addr: '0x0F5FAd045798b5BC1Eada8650D09fEE05D4090c5' },
                { label: 'Oracle',   addr: '0xC7c40108FA72A9C696a277B3496025AefeBc33b6' },
                { label: 'Treasury', addr: '0x95c02D478522b1B7616f433A22B7CDcBa259CA50' },
              ].map(({ label, addr }) => (
                <div
                  key={addr}
                  style={{
